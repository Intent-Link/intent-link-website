...
const en = {
  ...
  codeExample: {
    ...
    body: "Wrap once, then use IntentLink—or attach one ref to a custom element.",
  ...
  whyDifferent: {
    ...
    benefits: [
      ...
      { stat: "link / ref", title: "Two simple surfaces", body: "Use IntentLink for navigation and one ref for custom elements." },
      { stat: "React · Next", title: "Framework-native", body: "A drop-in for next/link in the Next.js App Router." },
      { stat: "MIT", title: "Small & open", body: "No data collection." },
    ],
  },
  beyondPrefetch: {
    ...
    body:
      "Prefetch is the flagship, but the same onIntent callback can prepare previews, data, assets, and interfaces.",
    uses: [
