...
const quickstart: DocText = {
  ...
  "intro": "انتقل من التثبيت إلى تنبؤ عامل في دقائق قليلة. يراقب intent-link حركة المؤشر، ويقدّر وجهتها بمرشّح كالمان، ويُطلق onIntent بمجرد أن يصبح رابط ما هو الهدف المرجّح — قبل النقرة.",
  "installHeading": "1 · التثبيت",
  "peerDeps": "التبعيات النظيرة: `react ≥ 18`، `react-dom ≥ 18`، `next ≥ 13`.",
  "wrapHeading": "2 · غلّف تطبيقك مرة واحدة",
  "wrapBody": "ركّب `IntentProvider` قرب الجذر. يُشغّل محرّك التنبؤ ويحسب احتمالاً حياً لكل هدف مُسجَّل. وهو مكوّن عميل، لذا في الـ App Router يجب أن يقع داخل حدود `\"use client\"`.",
