...
const de: TranslationBundle = {
  ...
  sections: {
    ...
    predictionFieldDemo: {
      ...
      importanceSub: "Auslösebereitschaft",
      costLabel: "cost",
      costSub: "Kosten einer Fehlauslösung",
  ...
  docs: {
    headings: {
      "importance-and-cost": "Feinabstimmung: Wichtigkeit & Kosten",
      "custom-components": "Eigene zielbewusste Komponenten",
    },
    groupTitles: {
    ...
    pageTitles: {
      ...
      "importance-and-cost": "Wichtigkeit und Kosten",
      "intent-provider": "IntentProvider",
      "intent-link": "IntentLink",
      "intent-context": "IntentContext",
      "predictive-prefetch": "Prädiktive Vorladung",
      "custom-components": "Eigene Komponenten",
      "beyond-prefetch": "Über die Vorladung hinaus",
      "mobile-behavior": "Mobiles Verhalten",
